        ...
        <>
          <main className="bg-background">
            <HeroSection
              ...
              family1={weddingConfig.family_name_1}
              family2={weddingConfig.family_name_2}
            />
          ...
          {isPlaying && <MusicToggle isMuted={isMuted} onToggle={toggleMute} />}
        </>
      )}
    </>
  );
